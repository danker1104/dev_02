...
- 저장소: Azure Storage Account (Table + Queue)
...
- Scheduler/Worker: APScheduler + Queue Worker
...
- InventoryEventTable
  - PartitionKey: device_id_item_id
  - RowKey: event_time_event_id
  - fields: event_type, delta_qty, created_at
...
- web 컨테이너 1개 (Next.js)
- api 컨테이너 1개 (FastAPI)
- worker 컨테이너 1개 (Queue Worker)
- Azure Storage Account 1개 (Table + Queue)
